...
class ChatApp:
    ...
    def update_balance(self):
        ...
        try:
            ...
            self.balance_text.color = ft.Colors.GREEN_600   # Установка зеленого цвета для успешного получения
        except Exception as e:
            # Обработка ошибки получения баланса
            self.balance_text.value = "Баланс: н/д"         # Установка текста ошибки
            self.balance_text.color = ft.Colors.RED_600     # Установка красного цвета для ошибки
    ...
    def main(self, page: ft.Page):
        ...
        async def send_message_click(e):
            ...
            try:
                ...
                self.message_input.border_color = ft.Colors.BLUE_600
                page.update()
